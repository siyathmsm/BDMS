 ...
 * @author SIYATH MSM
 */
public class super_admin_admin extends javax.swing.JFrame {

    /**
     * Creates new form super_admin
     */
    public super_admin_admin() {
        initComponents();
        try {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Super Admin - Admin");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            dbcon.iud("DELETE FROM admin WHERE `id` = '"+id+"' ");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            dbcon.iud("UPDATE admin SET `username` = '"+un+"' WHERE `id` = '"+id+"'");
            dbcon.iud("UPDATE admin SET `full_name` = '"+fn+"' WHERE `id` = '"+id+"'");
            dbcon.iud("UPDATE admin SET `email` = '"+em+"' WHERE `id` = '"+id+"'");
            dbcon.iud("UPDATE admin SET `contact_no` = '"+cn+"' WHERE `id` = '"+id+"'");
            dbcon.iud("UPDATE admin SET `address` = '"+ad+"' WHERE `id` = '"+id+"'");
            dbcon.iud("UPDATE admin SET `designation` = '"+dg+"' WHERE `id` = '"+id+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        super_admin_user sau = new super_admin_user();
        this.dispose();
        sau.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(super_admin_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new super_admin_admin().setVisible(true);
            }
        });
    }
