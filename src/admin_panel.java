...
public class admin_panel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, -1, 50));
        ...
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 0, 40, 50));

        jLabel13.setBackground(new java.awt.Color(0, 153, 153));
        jLabel13.setOpaque(true);
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 50));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/operator.png"))); // NOI18N
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        admin_operate_view aov = new admin_operate_view();
        this.dispose();
        aov.setVisible(true);
